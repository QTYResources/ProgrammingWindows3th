...
BEGIN_MESSAGE_MAP(CFirewallApp, CWinApp)
...
BOOL CFirewallApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CFirewallDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CFirewallView));
...
/////////////////////////////////////////////////////////////////////////////
// CFirewallAppApp message handlers
